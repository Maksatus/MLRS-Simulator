...
//     version 1.8.2
//     from Assets/Scripts/Scripts/Inputs/JUTPSInputControlls.inputactions
//
...
namespace JUTPS.JUInputSystem
{
    ...
    ""controlSchemes"": [
        ...
        ~@JUTPSInputControlls()
        {
            Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, JUTPSInputControlls.Player.Disable() has not been called.");
            Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, JUTPSInputControlls.UI.Disable() has not been called.");
        }
